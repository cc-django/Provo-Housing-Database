# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-03-07 22:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract_length', models.CharField(choices=[('Fall', 'Fall'), ('Summer', 'Summer'), ('Winter', 'Winter'), ('Fall/Winter', 'Fall/Winter'), ('Winter/Summer', 'Winter/Summer'), ('Summer/Fall', 'Summer/Fall'), ('Full Year', 'Full Year'), ('Other', 'Other'), ('No Contract', 'No Contract')], default='Fall/Winter', max_length=15)),
                ...
                ('upload_image', models.ImageField(blank=True, null=True, upload_to='media')),
                ...
                ('amenity', models.ManyToManyField(blank=True, to='main.Amenities')),
